...
function App() {
  ...
  return (
    <>
      ...
      {page === 1 && <Trivia topic={topic} intervalTime={3} goToNextPage={() => {setPage(2)}} questions={Questions} setQuestionInfo={setQuestions} questionTime={40} numberOfQuestions={3} logo={Logo}/>}
